...
module GeneratedUrlHelpers
  # Sigs for route /api/v1/activities(.:format)
  sig { params(args: T.untyped, kwargs: T.untyped).returns(String) }
  def api_v1_activities_path(*args, **kwargs); end

  sig { params(args: T.untyped, kwargs: T.untyped).returns(String) }
  def api_v1_activities_url(*args, **kwargs); end

  # Sigs for route /api/v1/activities/:id(.:format)
  sig { params(args: T.untyped, kwargs: T.untyped).returns(String) }
  def api_v1_activity_path(*args, **kwargs); end

  sig { params(args: T.untyped, kwargs: T.untyped).returns(String) }
  def api_v1_activity_url(*args, **kwargs); end
